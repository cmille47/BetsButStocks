                    ...
                    if (!empty($result)){
                        while($row = $result->fetch_assoc()) {
                            ...
                            if ($row['type'] == 'ML'){
                                ...
                                $type = 'ou_total';
                                $team1 = explode(' ', $row['away_team'], 2);
                                $team2 = explode(' ', $row['home_team'], 2);
                            ...
                            while($row2 = $result2->fetch_assoc()){
                                ...
                                if ($row['type'] == 'ML') {
                                    if ($row['bet_choice'] == 'Home') {
                                        $z = (1.0 + floatval($row2['s_home_line'])) / 14;
                                        $prob = exec("python3 normalcdf.py $z gt");
                                        $probs[] = $prob;
                                    }
                                    else {
                                        $z = (1.0 + floatval($row2['s_away_line'])) / 14;
                                        $prob = exec("python3 normalcdf.py $z gt");
                                        $probs[] = $prob;
                                    }
                                }
                            ...
                            if ($suggested_list_price < $ticket_cost) {
                                $list_price_str = "Optimal List Range: $" . $suggested_list_price . " - $" . $ticket_cost;
                                ...
                                $small_text = "The value of your bet has increased since your purchased it. Guarantee a profit now by selling it in this range.";
                            } 
                            else {
                                $list_price_str = "Optimal List Price: $" . $suggested_list_price;
                                $small_text = "The value of your bet has not changed since your purchased it.";
                            }
