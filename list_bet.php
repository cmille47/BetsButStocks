...
if (isset($_SESSION["user_id"])) {
    ...
    if ($amount > 0) {
        ...
        echo "<script type=\"text/javascript\"> alert('Bet successfully listed!'); window.location.href='show_user_bets.php';</script>";
        //header("Location: show_user_bets.php");
        exit;
    }
    else {
        echo "<script type=\"text/javascript\"> alert('Listing not processed! Enter positive dinteger input!'); window.location.href='show_user_bets.php';</script>";
    }
